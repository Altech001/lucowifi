  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
       <aside className="fixed top-14 inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-background sm:flex">
         <TooltipProvider>
            <nav className="flex flex-col items-center gap-6 px-2 sm:py-4 flex-1 ">
                ...
                <span className="sr-only">Luco V</span>
                </Link>
                <Tooltip>
                ...
                <Tooltip>
                    ...
                    <TooltipContent side="right">Active Vouchers</TooltipContent>
                </Tooltip>
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Link
                ...
                <Tooltip>
                    ...
                    <TooltipContent side="right">Analyze</TooltipContent>
                </Tooltip>
                 <Tooltip>
                    <TooltipTrigger asChild>
                        <Link
            ...
            <nav className="mt-auto flex flex-col items-center gap-4 px-2 sm:py-5">
                <Tooltip>
                    <TooltipTrigger asChild>
                         <form action={logout}>
                            <Button size="icon" variant="ghost" className="h-9 w-9 text-muted-foreground transition-colors hover:text-foreground md:h-8 md:w-8" type="submit">
